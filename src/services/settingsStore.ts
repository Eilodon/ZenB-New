  ...
  persist(
    (set, get) => ({
      ...
      registerSessionComplete: (durationSec, patternId, cycles) => {
        ...
        // Definition of "Success": Session > 45 seconds. 
        // Less than that implies user abandoned the protocol (Potential Stress/Trauma).
        const isSuccess = durationSec > 45;
        ...
        if (isSuccess) {
            ...
            // Reduce confidence (Trauma detected)
        ...
        if (durationSec > 10) {
            const newItem: SessionHistoryItem = {
                ...
                patternId,
                cycles,
                finalBelief: kernel.getState().belief
            };
