...
import { X, Volume2, VolumeX, Smartphone, SmartphoneNfc, Music, Check } from 'lucide-react';
        ...
        >
           ...
           <div className="space-y-10 max-h-[70vh] overflow-y-auto scrollbar-hide pb-12">
              ...
              <div className="pt-8 text-center">
                 <div className="text-[10px] text-white/20 font-mono">v1.9 • Built with ZenB Engine</div>
              </div>
           </div>
        </div>
      </div>
